...
export default function UserModal({ isOpen, onClose, onSave, user, mode }: UserModalProps) {
    ...
    try {
      ...
      if (mode === "edit" && user) {
        ...
        if (formData.role !== "Administrador") {
          // Call the updated handleSaveFunisPermissoes function
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative bg-card rounded-lg shadow-lg w-full max-w-2xl md:p-6 p-0 h-full md:h-auto flex flex-col">
        {/* Header - Desktop */}
        ...
        {/* Form */}
        <form onSubmit={handleSubmit} className="space-y-4 md:space-y-4 p-4 md:p-0 overflow-y-auto flex-1">
          {/* Avatar Preview - Desktop Only */}
          <div className="hidden md:flex flex-col items-center gap-3 pb-2 border-b">
          ...
          {/* Actions */}
          <div className="flex gap-3 pt-4 pb-safe md:pb-0">
            <Button 
              type="button" 
              variant="outline" 
              onClick={onClose} 
